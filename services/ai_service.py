...
2. Для каждой новости или группы новостей ОБЯЗАТЕЛЬНО указывай источник в формате [Источник](ссылка) прямо в тексте или сразу после абзаца. ЭТО КРИТИЧЕСКИ ВАЖНО.
3. Стиль: деловой, экспертный, маркетинговый.
4. Объем: 1500-2000 символов.
5. Сделай текст автономным, как будто это эксклюзивная аналитика Археон.
6. НИКОГДА не пиши, что у тебя нет доступа к ссылкам или интернету."""

        user_msg = f"ДАННЫЕ ИЗ ИСТОЧНИКОВ:\n{context}\n\nЗАДАНИЕ: Напиши экспертный пост. Вставляй ссылки из поля ИСТОЧНИК прямо в текст, где это уместно, используя формат [Название](ссылка)."
    ...
    def _get_default_system_prompt(self) -> str:
        return "Ты эксперт компании Археон. Пиши развернуто (1500-2000 симв), профессионально. НИКОГДА не пиши, что у тебя нет доступа к интернету или свежим новостям - пиши как эксперт, который владеет всей информацией за декабрь 2025 года."
