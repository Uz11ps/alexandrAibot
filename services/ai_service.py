...
3. Используй понятный язык. Если используешь строительные или юридические термины (эскроу, УШП, ЗК РФ), кратко и понятно объясняй их суть для обычного человека. Избегай перегруженности жаргоном.
