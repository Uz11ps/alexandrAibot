...
DEFAULT_POST_TYPES = {
    "monday": [
        {"time": "09:00", "name": "Отчет по объектам", "description": "Отчетные посты по текущим объектам с фотографиями", "enabled": False}
    ],
    "tuesday": [
        {"time": "09:00", "name": "Экспертная статья", "description": "Экспертная статья по земельным вопросам", "enabled": False}
    ],
    "wednesday": [
        {"time": "09:00", "name": "Отчет или мемы", "description": "Отчет по стройке или приколы, мемы, визуальный контент", "enabled": False}
    ],
    "thursday": [
        {"time": "09:00", "name": "Ответы на вопросы", "description": "Пост на основе частых вопросов клиентов", "enabled": False}
    ],
    "friday": [
        {"time": "09:00", "name": "Обзор проектов", "description": "Обзор текущих проектов с подборкой фото", "enabled": False}
    ],
    "saturday": [
        {"time": "09:00", "name": "Услуги компании", "description": "Пост об услугах компании", "enabled": False}
    ]
}
